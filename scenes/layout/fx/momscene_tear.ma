...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "teardop_droptop";
	rename -uid "7BFE14F1-C644-0DBC-9C66-ABBF26F5CD58";
createNode transform -n "baby_teardrop" -p "teardop_droptop";
	rename -uid "E5D34ABF-8840-88FA-7579-9298BFC2A88E";
createNode bifrostContainer -n "baby_teardropContainer" -p "baby_teardrop";
	rename -uid "729E5DEE-B44D-2173-3AB1-5EA3F4ABAAAD";
...
createNode transform -n "liquid1" -p "baby_teardrop";
	rename -uid "056526D2-5A45-1230-8A3F-E1B4E499E136";
createNode bifrostShape -n "liquidShape1" -p "liquid1";
	rename -uid "7EF5ABA6-DC41-6986-6939-8C90BCFC5B00";
	setAttr -k off ".v";
...
createNode transform -n "bifrostLiquidProperties1" -p "teardop_droptop";
	rename -uid "0D42ACAD-4040-391C-8054-D2ABB0042166";
createNode bifrostContainer -n "bifrostLiquidPropertiesContainer1" -p "bifrostLiquidProperties1";
	rename -uid "2F20DE1A-CE49-DCF2-F53D-29AE83B87510";
	addAttr -w false -s false -ci true -sn "Liquid" -ln "Liquid" -dt "string";
...
createNode transform -n "bifrostGuideProperties1" -p "teardop_droptop";
	rename -uid "6A1DD1BC-6844-40FE-24C1-D8B3F3E76A3A";
createNode bifrostContainer -n "bifrostGuidePropertiesContainer1" -p "bifrostGuideProperties1";
	rename -uid "BE490120-3D40-CDE6-CAAB-FFADF26C485F";
...
createNode transform -n "bifrostLiquid1Mesh" -p "teardop_droptop";
	rename -uid "1A5033F9-D049-2DEF-86EA-13B5514A5A72";
createNode mesh -n "bifrostLiquid1MeshShape" -p "bifrostLiquid1Mesh";
	rename -uid "E7BF91F0-C14B-FEB6-C4CF-06910657AA8C";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode reference -n "shotglassRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "currentColorSet" " -type \"string\" \"bifrostExpansionRate\""
		
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet" " -s 2"
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet[0].colorName" 
		" -type \"string\" \"bifrostDensity\""
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet[0].clamped" 
		" 0"
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet[0].representation" 
		" 3"
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet[1].colorName" 
		" -type \"string\" \"bifrostExpansionRate\""
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet[1].clamped" 
		" 0"
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "colorSet[1].representation" 
		" 3"
		2 "|teardop_droptop|shotglass:Cup|shotglass:CupShape" "quadSplit" " 0"
		3 "|teardop_droptop|shotglass:Cup|shotglass:CupShape.instObjGroups" ":initialShadingGroup.dagSetMembers" 
		"-na"
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "momscene_animRN.phl[1]" "colliderProps2.Meshes[0]";
...
connectAttr "bifrostLiquidPropertiesContainer1.Liquid" "baby_teardropContainer.liquidProperties"
		;
connectAttr "bifrostLiquidPropertiesContainer1.LiquidCache" "baby_teardropContainer.liquidCacheProperties"
		;
connectAttr "bifrostLiquidPropertiesContainer1.SolidCache" "baby_teardropContainer.solidCacheProperties"
		;
connectAttr "bifrostLiquidPropertiesContainer1.liquidmeshCache" "baby_teardropContainer.liquidmeshCacheProperties"
		;
connectAttr "bifrostGuidePropertiesContainer1.Guides" "baby_teardropContainer.guideProperties"
		;
connectAttr "bifrostGuidePropertiesContainer1.GuideCache" "baby_teardropContainer.guideCacheProperties"
		;
connectAttr "emitterProps1.outMeshes" "baby_teardropContainer.Emitters[0]";
connectAttr "emitterProps2.outMeshes" "baby_teardropContainer.Emitters[1]";
...
connectAttr "emitterProps1_startFrame.o" "emitterProps1.sfr";
