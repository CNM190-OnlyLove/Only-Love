...
//Name: teardrop_2.ma
//Last modified: Mon, Nov 21, 2016 06:44:44 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 47.287906979167445 39.703714610584576 10.006616761007363 ;
	setAttr ".r" -type "double3" -27.938352729554342 -999.79999999995039 -9.3430586925614655e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FA0B53E5-7C45-6FE2-CE77-F9ADBA8DB122";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 58.092661924275696;
...
createNode bifrostContainer -n "bifrostLiquidContainer1" -p "bifrostLiquid1";
	...
	setAttr -k on ".liquidCachePath" -type "string" "/Users/emileechen/Documents/project/Only-Love//cache/bifrost/teardrop_2/";
	setAttr -k on ".liquidCacheFileName" -type "string" "bifrostLiquidContainer1_liquid";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "14B5BB75-DE41-06B9-E601-3DAFC187526B";
	setAttr -s 14 ".lnk";
	setAttr -s 14 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "059CC81D-D74B-715E-CCE4-8DAFBAC451B3";
createNode displayLayer -n "defaultLayer";
	rename -uid "9F0267F0-A046-6DA6-873A-7AA1B8457774";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8CAFA66B-8F43-12F3-EFA4-60A73CEA9A1F";
