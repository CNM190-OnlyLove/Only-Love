...
//Last modified: Tue, Apr 04, 2017 02:42:52 AM
//Codeset: 1252
...
createNode bifrostContainer -n "bifrostLiquidPropertiesContainer1" -p "bifrostLiquidProperties1";
	...
	setAttr -k on ".liquidCacheFileName" -type "string" "two";
	...
	setAttr -k on ".solidCacheFileName" -type "string" "two";
...
createNode bifrostContainer -n "bifrostGuidePropertiesContainer1" -p "bifrostGuideProperties1";
	...
	setAttr ".guideCacheFileName" -type "string" "two";
...
createNode bifrostContainer -n "colliderProps1" -p "bifrostColliderProps1";
	...
	setAttr -k on ".bifrostThickness" 0.85;
	setAttr -k on ".bifrostMode";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "ACC3EA89-4D72-8551-4447-6BBB68957FFE";
	setAttr -s 84 ".lnk";
	setAttr -s 84 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BB2BE480-476C-2BFD-B6C9-339E34B80BFA";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4385DB55-4865-FE8E-8799-07B32DF4ADFA";
createNode displayLayerManager -n "layerManager";
	rename -uid "86ACC876-4974-1789-60FB-5FB36A9FC33F";
createNode displayLayer -n "defaultLayer";
	rename -uid "53AC7564-4515-DF76-3303-AE8B88C2ADC1";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "08DEA0EB-42A5-623F-AA1E-22A4344C50D0";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 380 -max 440 -ast 1 -aet 520 ";
	setAttr ".st" 6;
createNode reference -n "liqstore_animRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -2.931234795463979 16.950961491698447 73.03208226222705"
		
		2 "|Extra|liqstore_anim:reggie_rig:Reggie_Rig|liqstore_anim:reggie_rig:ReggieMasterControl|liqstore_anim:reggie_rig:Head_Neck_GRP|liqstore_anim:reggie_rig:NeckIk" 
		"rotate" " -type \"double3\" 96.880746732590552 1.2244587520431045 -74.356207520072516"
		...
		2 "|Extra|liqstore_anim:liquor_cam:phase_5_cam" "translate" " -type \"double3\" -4131.4908425299409 68.482402256868184 -462.80394999178782"
		...
		"farClipPlane" " 10000"
		2 "|Extra|liqstore_anim:liquor_cam:phase_5_cam|liqstore_anim:liquor_cam:phase_5_camShape" 
		"centerOfInterest" " 44.976158598390995"
		2 "|Extra|liqstore_anim:liquor_cam:phase_5_cam|liqstore_anim:liquor_cam:phase_5_camShape" 
		"tumblePivot" " -type \"double3\" -4127.787882725499 37.937699120320801 -484.46615058519291"
