...
//Name: main_scene.ma
//Last modified: Fri, Nov 11, 2016 04:25:50 PM
//Codeset: UTF-8
...
file -rdi 1 -ns "church" -rfn "churchRN" -op "v=0;" -typ "mayaAscii" "/Users/veronicachen/Desktop/Only-Love//assets/church/church.ma";
...
file -r -ns "liquor_store" -dr 1 -rfn "liquor_storeRN" -op "v=0;" -typ "mayaAscii"
		 "/Users/veronicachen/Desktop/Only-Love//assets/liquor_store/liquor_store.ma";
file -r -ns "church" -dr 1 -rfn "churchRN" -op "v=0;" -typ "mayaAscii" "/Users/veronicachen/Desktop/Only-Love//assets/church/church.ma";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 610.53824056330473 1645.6040358702901 6923.657767607534 ;
	setAttr ".r" -type "double3" -11.738352729581814 18.999999999999503 4.2047755109511103e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7782.4166372902973;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1431.2935393901198 745.39767131668827 -185.23049229867604 ;
...
createNode transform -n "sidewalk";
	...
	setAttr ".t" -type "double3" -1431.2935393901198 -131.39861679237845 -160.15950620808076 ;
	setAttr ".s" -type "double3" 4819.9474954893003 54.53434554950806 3027.3298706920018 ;
createNode mesh -n "sidewalkShape" -p "sidewalk";
	rename -uid "02CA59F7-B449-3F0A-5837-56B1C7C0A717";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.4999999925494194 0.37527298927307129 ;
	...
	setAttr ".dr" 1;
createNode transform -n "mattePainting";
	rename -uid "6397CC98-6847-8EB7-022F-FCB07D7973C1";
	setAttr ".t" -type "double3" -1998.9336542969711 745.39767131668827 -1682.2545888996949 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".s" -type "double3" 3642.451035715575 1861.7907611861865 1861.7907611861865 ;
createNode mesh -n "mattePaintingShape" -p "mattePainting";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BB5D499B-D442-9D24-62C1-218B9CE7A143";
	setAttr -s 65 ".lnk";
	setAttr -s 65 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "FC8AF3F1-9F4A-8E15-7DB0-D6BE3137E382";
createNode displayLayer -n "defaultLayer";
	rename -uid "2E0E5D4F-6948-FB65-C22F-2BAC379F4B02";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "596BBE18-9C4D-AE54-0005-F5980C0EAF38";
...
createNode reference -n "liquor_storeRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"liquor_storeRN" 0
		"liquor_storeRN" 33
		2 "|liquor_store:LiquorStore" "translate" " -type \"double3\" 333.95659109936696041 -115.77641045236941864 0"
...
createNode reference -n "sharedReferenceNode";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode reference -n "churchRN";
	rename -uid "F59DDAC9-6249-EE26-864C-EDA66EF445F2";
	setAttr ".fn[0]" -type "string" "/Users/veronicachen/Desktop/Only-Love//assets/church/church.ma";
	setAttr ".ed" -type "dataReferenceEdits" 
		"churchRN"
		"churchRN" 0
		"churchRN" 3
		2 "|church:Church" "translate" " -type \"double3\" -1942.96430094328593441 22.66731538106012067 -743.28579848825506815"
		
		2 "|church:Church" "scale" " -type \"double3\" 1.45823591299387179 1.45823591299387179 1.45823591299387179"
		
		2 "|church:Church|church:All_ChurchParts|church:mainroof" "translate" " -type \"double3\" -0.45748169140547718 0 0";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "benchRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|bench:Bench|bench:BenchLogs" "translate" " -type \"double3\" -2540.86806324669714741 0 -192.78810650947630734"
		
		2 "|bench:Bench|bench:BenchLogs" "rotate" " -type \"double3\" 0 75.83478390149254267 0"
		
		2 "|bench:Bench|bench:BenchLogs" "scale" " -type \"double3\" 27.03114215202481674 27.03114215202481674 27.03114215202481674"
		
		2 "|bench:Bench|bench:Legs" "translate" " -type \"double3\" -2540.86806324669714741 0 -192.78810650947630734"
		
		2 "|bench:Bench|bench:Legs" "rotate" " -type \"double3\" 0 75.83478390149254267 0"
...
createNode reference -n "streetLightRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"streetLightRN" 0
		"streetLightRN" 15
		2 "|streetLight:Streetlight" "translate" " -type \"double3\" -2530.80465340392083817 -109.94957235225700742 -520.75480084677826653"
...
createNode reference -n "firehydrantRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|firehydrant:Firehydrant|firehydrant:firehydrant" "translate" " -type \"double3\" 428.71954355543749671 -115.77641045236941864 181.41670141170132524"
...
createNode reference -n "streetLightRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"streetLightRN1" 0
		"streetLightRN1" 3
		2 "|streetLight1:Streetlight" "translate" " -type \"double3\" 402.01359660540464347 -105.97705515643906438 -520.0541945457350721"
...
createNode polyCube -n "polyCube1";
	rename -uid "BF21F6A0-654C-EEB8-DF4F-04BD07D9E500";
	setAttr ".cuv" 4;
createNode polySplitRing -n "polySplitRing1";
	rename -uid "7C9B7E4C-9740-CB5F-3AD5-85879C081819";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 2 "e[4:5]" "e[8:9]";
	setAttr ".ix" -type "matrix" 4819.9474954893003 0 0 0 0 54.53434554950806 0 0 0 0 3027.3298706920018 0
		 -1431.2935393901198 -131.39861679237845 -160.15950620808076 1;
	setAttr ".wt" 0.8214147686958313;
	setAttr ".dr" no;
	setAttr ".re" 4;
...
createNode polySplitRing -n "polySplitRing2";
	rename -uid "5EC46D26-3C46-9949-16C6-328AC1581DCD";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[0:3]" "e[16]" "e[19]";
	setAttr ".ix" -type "matrix" 4819.9474954893003 0 0 0 0 54.53434554950806 0 0 0 0 3027.3298706920018 0
		 -1431.2935393901198 -131.39861679237845 -160.15950620808076 1;
	setAttr ".wt" 0.998771071434021;
	setAttr ".dr" no;
	setAttr ".re" 19;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
...
createNode polySplitRing -n "polySplitRing3";
	rename -uid "F8F8951E-DF44-6B70-0913-8B83A476BCAE";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 6 "e[6:7]" "e[10:11]" "e[14]" "e[18]" "e[24]" "e[30]";
	setAttr ".ix" -type "matrix" 4819.9474954893003 0 0 0 0 54.53434554950806 0 0 0 0 3027.3298706920018 0
		 -1431.2935393901198 -131.39861679237845 -160.15950620808076 1;
	setAttr ".wt" 0.0011426357086747885;
	setAttr ".re" 14;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polySplitRing -n "polySplitRing4";
	rename -uid "08EB9ECF-2346-3A98-E4A7-EE94DEB0A56D";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 7 "e[4:5]" "e[13]" "e[15]" "e[22]" "e[26]" "e[34]" "e[40]";
	setAttr ".ix" -type "matrix" 4819.9474954893003 0 0 0 0 54.53434554950806 0 0 0 0 3027.3298706920018 0
		 -1431.2935393901198 -131.39861679237845 -160.15950620808076 1;
	setAttr ".wt" 0.10194005817174911;
	setAttr ".re" 4;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polySplitRing -n "polySplitRing5";
	rename -uid "130734AD-AB4D-8236-DDFC-E68992393DB0";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 10 "e[19]" "e[21]" "e[23]" "e[25]" "e[27]" "e[29]" "e[38]" "e[44]" "e[56]" "e[62]";
	setAttr ".ix" -type "matrix" 4819.9474954893003 0 0 0 0 54.53434554950806 0 0 0 0 3027.3298706920018 0
		 -1431.2935393901198 -131.39861679237845 -160.15950620808076 1;
	setAttr ".wt" 0.00056604482233524323;
	setAttr ".re" 19;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polySplitRing -n "polySplitRing6";
	rename -uid "4E08BC91-0144-16C7-BA59-42842044083F";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 11 "e[10:11]" "e[18]" "e[30]" "e[32]" "e[35]" "e[41]" "e[45]" "e[52]" "e[58]" "e[72]" "e[80]";
	setAttr ".ix" -type "matrix" 4819.9474954893003 0 0 0 0 54.53434554950806 0 0 0 0 3027.3298706920018 0
		 -1431.2935393901198 -131.39861679237845 -160.15950620808076 1;
	setAttr ".wt" 0.0021863651927560568;
	setAttr ".re" 18;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polyPlane -n "polyPlane1";
	rename -uid "2F9AAE58-E64D-F33D-894F-FE835C598046";
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode reference -n "Extra_BuildingsRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -2039.86018351909933699 -242.03401318436755218 -1227.41931183369524661"
		...
		"translate" " -type \"double3\" -2139.68070073298440548 -249.40674750072082588 -1227.41931183369524661"
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polySplitRing6.out" "sidewalkShape.i";
connectAttr "polyPlane1.out" "mattePaintingShape.i";
...
connectAttr "sharedReferenceNode.sr" "churchRN.sr";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "sharedReferenceNode.sr" "fogTestRN.sr";
connectAttr "polyCube1.out" "polySplitRing1.ip";
connectAttr "sidewalkShape.wm" "polySplitRing1.mp";
connectAttr "polySplitRing1.out" "polySplitRing2.ip";
connectAttr "sidewalkShape.wm" "polySplitRing2.mp";
connectAttr "polySplitRing2.out" "polySplitRing3.ip";
connectAttr "sidewalkShape.wm" "polySplitRing3.mp";
connectAttr "polySplitRing3.out" "polySplitRing4.ip";
connectAttr "sidewalkShape.wm" "polySplitRing4.mp";
connectAttr "polySplitRing4.out" "polySplitRing5.ip";
connectAttr "sidewalkShape.wm" "polySplitRing5.mp";
connectAttr "polySplitRing5.out" "polySplitRing6.ip";
connectAttr "sidewalkShape.wm" "polySplitRing6.mp";
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "sidewalkShape.iog" ":initialShadingGroup.dsm" -na;
connectAttr "mattePaintingShape.iog" ":initialShadingGroup.dsm" -na;
