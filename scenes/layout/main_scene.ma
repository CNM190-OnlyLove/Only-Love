...
//Name: main_scene.ma
//Last modified: Fri, Nov 11, 2016 01:57:17 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2664.1245141654094 367.0264829559386 1493.7925120502939 ;
	setAttr ".r" -type "double3" -8.1383527296056162 -11.399999999998425 -1.0139269252111695e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E9B4C522-1241-DDD5-4B07-858375D4857B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 2096.1037511979639;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1243.7751075316173 561.62114011337769 -465.959382271815 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "143892B0-FC4B-3EDE-E269-778DFDA86F50";
	setAttr -s 53 ".lnk";
	setAttr -s 53 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "6F319961-7D45-7154-DB36-86AD16EBCB62";
createNode displayLayer -n "defaultLayer";
	rename -uid "2E0E5D4F-6948-FB65-C22F-2BAC379F4B02";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DDCEE910-1244-E1B7-B2A4-7589D8BFE3CA";
...
createNode reference -n "liquor_storeRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"liquor_storeRN" 0
		"liquor_storeRN" 14
		2 "|liquor_store:LiquorStore" "translate" " -type \"double3\" 333.95659109936696041 0 0"
...
createNode reference -n "churchRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"churchRN" 0
		"churchRN" 2
		2 "|church:Church" "translate" " -type \"double3\" -1942.96430094328593441 0 -743.28579848825506815"
...
createNode reference -n "streetLightRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"streetLightRN" 0
		"streetLightRN" 3
		2 "|streetLight:Streetlight" "translate" " -type \"double3\" -2669.09601884201993016 -96.92051939360237611 -508.62149134750598023"
