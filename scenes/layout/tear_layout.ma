...
//Name: tear_layout.ma
//Last modified: Sat, Oct 29, 2016 07:49:07 PM
//Codeset: UTF-8
requires maya "2016";
requires -nodeType "mentalrayFramebuffer" -nodeType "mentalrayOptions" -nodeType "mentalrayGlobals"
		 -nodeType "mentalrayItemsList" -dataType "byteArray" "Mayatomr" "2016.0 - 3.13.1.2 ";
requires "stereoCamera" "10.0";
requires -nodeType "RenderMan" -nodeType "PxrLMGlass" "RenderMan_for_Maya" "20.3";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "353CD740-C545-BB9B-6E69-DE906E91E41D";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "2E54868B-D949-923F-9EA5-008F21F2AA4B";
createNode displayLayer -n "defaultLayer";
	rename -uid "D2E1BE2B-7D4A-8D49-96B1-1281A0CEE653";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2F9785F6-DE43-5DAB-B69E-C5819C8CCEB3";
...
createNode animCurveTL -n "persp1_translateY";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  24 41.625421782699107 53 41.625421782699107
		 93 38.96970784393271 219 36.360673943349944 306 21.925301593065164 316 19.031456322784834
		 357 2.5148103268507533;
	setAttr -s 7 ".kit[0:6]"  18 18 1 1 1 1 1;
	setAttr -s 7 ".kot[0:6]"  18 18 1 1 1 1 1;
	setAttr -s 7 ".kix[2:6]"  0.98997503519058228 0.80856233835220337 
		0.13967899978160858 0.1340334415435791 0.080216921865940094;
	setAttr -s 7 ".kiy[2:6]"  -0.14124272763729095 -0.58841049671173096 
		-0.99019688367843628 -0.99097681045532227 -0.99677747488021851;
	setAttr -s 7 ".kox[2:6]"  0.98997503519058228 0.80856233835220337 
		0.13967898488044739 0.1340334564447403 0.080216951668262482;
	setAttr -s 7 ".koy[2:6]"  -0.14124275743961334 -0.58841061592102051 
		-0.99019688367843628 -0.99097681045532227 -0.99677741527557373;
createNode animCurveTL -n "persp1_translateZ";
	rename -uid "C35CD0C4-1842-8703-5AAF-ADABC7C80465";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  24 9.4663422378814683 49 15.245267632192764
		 93 29.467848351875851 219 23.79449623460895 302 12.18658432716175 306 11.323222037197395
...
createNode animCurveTU -n "persp1_visibility";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  24 1 49 1 93 1 219 1 302 1 306 1 316 1 337 1
		 347 1 356 1;
...
createNode animCurveTA -n "persp1_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  24 -21.538414479116433 49 -22.923369150616075
		 93 20.104090134897181 219 22.938436172478735 302 22.938436172478735 306 22.938436172478735
		 316 22.938436172478735 337 22.938436172478735 356 22.938436172478735;
	setAttr -s 9 ".kit[2:8]"  1 18 18 18 18 18 18;
	setAttr -s 9 ".kot[2:8]"  1 18 18 18 18 18 18;
	setAttr -s 9 ".kix[2:8]"  0.99978989362716675 1 1 1 1 1 1;
	setAttr -s 9 ".kiy[2:8]"  0.020499696955084801 0 0 0 0 0 0;
	setAttr -s 9 ".kox[2:8]"  0.99978989362716675 1 1 1 1 1 1;
	setAttr -s 9 ".koy[2:8]"  0.020499708130955696 0 0 0 0 0 0;
createNode animCurveTA -n "persp1_rotateZ";
	rename -uid "87A7B1CD-474F-257B-15E1-BE84BC4EC1C5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  24 -2.1451557837565458 52 -3.5931779228988496
		 93 -1.8764558195735876 219 -1.8764558195735876 302 -4.5171427231864758 306 -4.5171427231864758
		 316 -4.5171427231864758 337 -4.5171427231864758 347 -4.5171427231864758 356 -4.5171427231864758;
	setAttr -s 10 ".kit[2:9]"  1 18 18 18 18 18 18 18;
	setAttr -s 10 ".kot[2:9]"  1 18 18 18 18 18 18 18;
	setAttr -s 10 ".kix[2:9]"  0.9999803900718689 1 1 1 1 1 1 1;
	setAttr -s 10 ".kiy[2:9]"  0.0062632551416754723 0 0 0 0 0 0 0;
	setAttr -s 10 ".kox[2:9]"  0.9999803900718689 1 1 1 1 1 1 1;
	setAttr -s 10 ".koy[2:9]"  0.0062632537446916103 0 0 0 0 0 0 0;
...
createNode animCurveTU -n "persp1_scaleY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  24 1 49 1 93 1 219 1 302 1 306 1 316 1 337 1
		 356 1;
...
createNode animCurveTL -n "persp1_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  24 -2.0922837278222097 49 -4.9803977303848868
		 93 17.152027087714046 219 16.182210972587139 302 7.2903938198096796 306 6.6802856642715565
		 356 4.1336529859997011;
...
createNode animCurveTA -n "persp1_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  24 -81.916885222881305 49 -40.856318898756577
		 93 -3.4054214818096855 219 -1.1640179140214746 302 -1.1640179140214746 306 -1.1640179140214746
		 316 -1.1640179140214746 337 -1.1640179140214746 356 -1.1640179140214746;
select -ne :time1;
	setAttr ".o" 132;
	setAttr ".unw" 132;
