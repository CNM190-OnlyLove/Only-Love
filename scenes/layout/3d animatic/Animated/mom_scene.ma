...
//Name: mom_scene.ma
//Last modified: Tue, Dec 13, 2016 02:22:06 PM
//Codeset: UTF-8
...
createNode fosterParent -n "wineRNfosterParent1";
	rename -uid "F22B9EF0-2B41-4AC9-7E97-C1934D98D9FB";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7EFFABCF-8347-50B8-2C0A-5DAC2577C24A";
	setAttr -s 118 ".lnk";
	setAttr -s 118 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "546248E9-CD49-AB0B-B4FD-E6BE5A4631F2";
	setAttr ".cdl" 3;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4B20D593-FD4F-9AA0-1ABB-A2ACF1B96F9C";
...
createNode animCurveTL -n "persp1_translateX";
	...
	setAttr -s 5 ".ktv[0:4]"  1 0.79122028484079698 120 -1.8697365247628621
		 152 -1.8697365247628621 233 -0.7694503644442019 347 -0.21930721753040494;
	setAttr -s 5 ".kit[1:4]"  1 18 18 18;
	setAttr -s 5 ".kot[1:4]"  1 18 18 18;
	setAttr -s 5 ".kix[1:4]"  1 1 0.97998636960983276 1;
...
createNode animCurveTL -n "persp1_translateY";
	...
	setAttr -s 5 ".ktv[0:4]"  1 7.0675408531745756 122 5.549203108295738
		 152 5.549203108295738 233 4.5718394756957013 358 1.5262002573816389;
	setAttr -s 5 ".kit[1:4]"  1 18 18 18;
	setAttr -s 5 ".kot[1:4]"  1 18 18 18;
	setAttr -s 5 ".kix[1:4]"  1 1 0.90547657012939453 1;
	setAttr -s 5 ".kiy[1:4]"  0 0 -0.42439624667167664 0;
	setAttr -s 5 ".kox[1:4]"  1 1 0.90547651052474976 1;
	setAttr -s 5 ".koy[1:4]"  0 0 -0.42439621686935425 0;
createNode animCurveTL -n "persp1_translateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  1 14.789161107698632 100 27.612537355305676
		 152 27.620393632370295 233 23.836904705320208 358 23.836904705320208;
	setAttr -s 5 ".kit[1:4]"  1 18 18 18;
	setAttr -s 5 ".kot[1:4]"  1 18 18 18;
...
createNode animCurveTU -n "persp1_visibility";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 1 126 1 152 1 233 1 358 1;
...
createNode animCurveTA -n "persp1_rotateX";
	...
	setAttr -s 5 ".ktv[0:4]"  1 -77.342970292082441 100 -5.335570042745247
		 152 -4.984227234053189 233 -5.2763249422061866 358 -25.845000323810719;
	setAttr -s 5 ".kit[1:4]"  1 18 18 18;
	setAttr -s 5 ".kot[1:4]"  1 18 18 18;
	setAttr -s 5 ".ktl[1:4]" no yes yes yes;
	setAttr -s 5 ".kwl[1:4]" no yes yes yes;
	setAttr -s 5 ".kix[1:4]"  8.5342521667480469 2.1666669845581055 3.3749995231628418 
		5.2083339691162109;
	setAttr -s 5 ".kiy[1:4]"  -0.041271686553955078 0 -0.01529419980943203 
		0;
	setAttr -s 5 ".kox[1:4]"  7.2577743530273438 3.3749995231628418 5.2083339691162109 
		5.2083339691162109;
	setAttr -s 5 ".koy[1:4]"  0.041734036058187485 0 -0.023602167144417763 
		0;
createNode animCurveTA -n "persp1_rotateY";
	...
	setAttr -s 5 ".ktv[0:4]"  1 2.6137533886707347 126 4.0400000000000196
		 152 4.0400000000000196 233 4.0400000000000196 358 2.0395426770794622;
	setAttr -s 5 ".kit[1:4]"  1 18 18 18;
	setAttr -s 5 ".kot[1:4]"  1 18 18 18;
	setAttr -s 5 ".kix[1:4]"  1 1 1 1;
	setAttr -s 5 ".kiy[1:4]"  0 0 0 0;
...
createNode animCurveTA -n "persp1_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -1.9899168819792516e-16 126 0 152 0 233 0
		 358 0;
	setAttr -s 5 ".kit[1:4]"  1 18 18 18;
	setAttr -s 5 ".kot[1:4]"  1 18 18 18;
	setAttr -s 5 ".kix[1:4]"  1 1 1 1;
...
createNode reference -n "momRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 158.51271675259377503 200.43275546671870302 -184.81402962175164362"
		...
		2 "|mom1:mom_spline_ik_DONOTTOUCH" "translate" " -type \"double3\" -0.008021105302680423 -2.38286549321197905 -1.82848720697007083"
		
		2 "|mom1:mom_spline_ik_DONOTTOUCH" "rotate" " -type \"double3\" 90.39607036447068822 -8.08980362865452385 88.60300075150202304"
...
connectAttr "wine_bottle_visibility.o" "wineRN.phl[5]";
