...
//Name: mom_scene_layout.ma
//Last modified: Wed, Dec 07, 2016 01:36:13 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.007020329251207 13.153490658407895 25.641938571080384 ;
	setAttr ".r" -type "double3" -30.338352729628109 14.999999999999273 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FB8E18EC-ED47-F5D3-D87D-E3AB0942D3D3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 25.230305194923233;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.90111996825625684 7.1328592128966246 14.204806655704665 ;
...
createNode camera -n "momBabyShape" -p "momBaby";
	...
	setAttr ".rnd" no;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 39.381727087753674;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "19EF489A-BB41-9F63-07BB-3A9D8A90A7B5";
	setAttr -s 118 ".lnk";
	setAttr -s 118 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "11AD7981-0046-6BDA-BEA2-E2A37FAA3F2C";
	setAttr -s 5 ".dli[1:4]"  1 2 3 4;
	setAttr -s 5 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "8FE7AEEF-A64E-0BCA-8F16-3E847524724C";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EFCE89A9-F04B-02B4-EB6D-809CF6819DF0";
...
createNode animCurveTA -n "persp1_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 4 ".ktv[0:3]"  1 -77.342970292082427 126 -0.99100000000000121
...
createNode reference -n "momRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 158.51271675259368976 200.43275546671873144 -184.81402962175098992"
		...
		2 "|mom1:mom_spline_ik_DONOTTOUCH" "translate" " -type \"double3\" 0.1334156185087419 1.50957597734276394 0.51315541707498991"
		
		2 "|mom1:mom_spline_ik_DONOTTOUCH" "rotate" " -type \"double3\" 90.38185031255883928 -13.02131181927769177 88.56998011441186236"
...
createNode reference -n "babyRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|baby:baby_master" "translate" " -type \"double3\" 2.64763035304658612 15.8948943055533789 3.57697780961336154"
		...
		"translate" " -type \"double3\" 0 -7.16089489296310688 -1.97926972318500205"
		2 "|baby:baby_master|baby:baby_COG|baby:baby_spine|baby:Spine_IK_Handle" 
		"rotate" " -type \"double3\" 90 3.44599548997521365 90"
		...
		2 "|baby:baby_master|baby:baby_COG|baby:baby_c_pelvis_def|baby:baby_c_spine1_def|baby:baby_c_spine2_def|baby:baby_c_spine3_def|baby:baby_c_cspine_def|baby:baby_c_neck1_def|baby:baby_c_neck2_def|baby:baby_c_head_def|baby:baby_rt_eye_def|baby:baby:rEyeball|baby:baby:rEyeballShape" 
		"displaySmoothMesh" " 2"
		2 "|baby:bb_face_master" "translate" " -type \"double3\" 0 10.77190905783661279 0"
		
		2 "|baby:bb_expr_master" "translate" " -type \"double3\" 0.93340426054695058 -29.61852890208280797 0";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "bibleRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|bible2:Bible|bible2:BibleMesh" "translate" " -type \"double3\" -3.81322380122925164 -6.13746724866894233 12.81861231285943958"
...
createNode reference -n "wineRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"wineRN" 0
		"wineRN" 2
		2 "|wine:wine_bottle" "translate" " -type \"double3\" -3.70010491024716215 -2.15976890984856418 12.30696289522148312"
...
createNode reference -n "chairRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|chair:Chair|chair:chair" "translate" " -type \"double3\" 0 -16.37767760682001494 -9.27423766773738834"
...
createNode animCurveTU -n "mom_cog_ctrl_visibility";
	rename -uid "8C3DADAD-2546-2CF8-C817-8BB5429D010A";
	setAttr ".tan" 9;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  5;
createNode animCurveTL -n "mom_cog_ctrl_translateX";
	rename -uid "625EBA8A-E243-82DC-3DE8-4C90F17BA597";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 0;
	setAttr ".kot[0]"  18;
createNode animCurveTL -n "mom_cog_ctrl_translateY";
	rename -uid "9B73DFAD-A64E-9515-EEDB-07A3294BBF04";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 -2.2458605407107634e-16;
	setAttr ".kot[0]"  18;
createNode animCurveTL -n "mom_cog_ctrl_translateZ";
	rename -uid "8801E42C-A142-24E8-85AB-5BA3E9692564";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 0;
	setAttr ".kot[0]"  18;
createNode animCurveTA -n "mom_cog_ctrl_rotateX";
	rename -uid "38386FE0-EB4E-5C13-5500-F884060D01A3";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 17.997616246759883;
	setAttr ".kot[0]"  18;
createNode animCurveTA -n "mom_cog_ctrl_rotateY";
	rename -uid "66C8EA49-F74B-1388-1776-3AB289CD3C60";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 0.373140829879124;
	setAttr ".kot[0]"  18;
createNode animCurveTA -n "mom_cog_ctrl_rotateZ";
	rename -uid "94795FD2-E440-6222-4EFF-3C8ABB210E91";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 -1.8779620701420847;
	setAttr ".kot[0]"  18;
createNode animCurveTU -n "mom_cog_ctrl_scaleX";
	rename -uid "283754D8-9542-2133-D09A-B99534FE5001";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  18;
createNode animCurveTU -n "mom_cog_ctrl_scaleY";
	rename -uid "6FB96720-CF4F-7BB5-D3FA-81BD87C77B5A";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  18;
createNode animCurveTU -n "mom_cog_ctrl_scaleZ";
	rename -uid "3B7A5A16-8646-2B52-8981-749EFA827D11";
	setAttr ".tan" 16;
	setAttr ".ktv[0]"  1 1;
	setAttr ".kot[0]"  18;
...
connectAttr "mom_l_pinky0_visibility.o" "momRN.phl[7]";
connectAttr "mom_l_pinky0_translateX.o" "momRN.phl[8]";
connectAttr "mom_l_pinky0_translateY.o" "momRN.phl[9]";
connectAttr "mom_l_pinky0_translateZ.o" "momRN.phl[10]";
connectAttr "momRN.phl[11]" "pairBlend1.w";
