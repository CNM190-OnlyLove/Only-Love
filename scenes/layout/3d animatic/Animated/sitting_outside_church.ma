...
//Last modified: Sun, Dec 04, 2016 07:00:55 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3255.7890059447222 503.33973885732638 757.81307800559921 ;
	setAttr ".r" -type "double3" -9.9383527295914451 323.79999999994368 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 1408.1687215440854;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0996CBBF-EB4B-6765-AA14-0F8B8C2BF6D9";
	setAttr -s 76 ".lnk";
	setAttr -s 76 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "53227061-0B4B-48BD-7F48-828FAB3A84DC";
createNode displayLayer -n "defaultLayer";
	rename -uid "2E0E5D4F-6948-FB65-C22F-2BAC379F4B02";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "790ED9B3-5C42-1B42-0C97-59ACBE45E2BF";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 168 -ast 1 -aet 432 ";
	setAttr ".st" 6;
