...
//Last modified: Sun, Dec 04, 2016 07:23:41 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2055.9298781698517 1297.7016132911128 3152.4193576197672 ;
	setAttr ".r" -type "double3" -15.338352729591433 388.99999999994151 9.0912503328569614e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 4711.0412882693199;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -4258.5347305910673 51.543342913815906 -821.18498215024056 ;
...
createNode camera -n "churchCameraShape" -p "churchCamera";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 67.379549705552108;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5560753E-C045-0C87-F769-358A2254CB4C";
	setAttr -s 76 ".lnk";
	setAttr -s 76 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "AEA375BA-F642-F556-D2AE-FD814F5C26BD";
createNode displayLayer -n "defaultLayer";
	rename -uid "2E0E5D4F-6948-FB65-C22F-2BAC379F4B02";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B8255780-0E47-4041-4BBC-549C2D0F8479";
...
createNode animCurveTL -n "liquorstoreCamera_translateZ";
	...
	setAttr ".tan" 16;
	setAttr -s 2 ".ktv[0:1]"  169 -840.11742219472671 409 -226.24957101489508;
	setAttr -s 2 ".kot[0:1]"  18 18;
