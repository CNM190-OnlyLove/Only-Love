...
//Name: size_test2.ma
//Last modified: Sat, Oct 29, 2016 04:54:50 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 27.03086330443853 16.125947310094535 41.266497617207953 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 46.219561249151575;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "770E324B-2C4A-8A39-9907-5CA264A334A4";
	setAttr -s 75 ".lnk";
	setAttr -s 75 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "B1999B0C-4247-9EDD-F364-B2BD85AE68B9";
createNode displayLayer -n "defaultLayer";
	rename -uid "BFBC5B7D-A44A-FFB9-49F4-299FB73127C5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CB903E8B-6145-785D-4A89-749DA09E1989";
