...
//Name: baby.ma
//Last modified: Wed, Nov 09, 2016 02:59:48 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.5667202799906335 -8.0273933750368656 39.195417990298658 ;
	setAttr ".r" -type "double3" 358.46164812620361 2884.1999999996906 1.2457496615348686e-17 ;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.7566820097279185 100.1 0.57111684372292015 ;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.50009907186532 -21.47279582497654 -1.3120001450182517 ;
...
createNode joint -n "baby_lf_shoulder_def" -p "baby_lf_collar_def";
	...
	setAttr ".t" -type "double3" 2.4758588558790797 8.8817841970012523e-16 3.3306690738754696e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "baby_lf_pinky1_def" -p "baby_lf_cup_def";
	...
	setAttr ".t" -type "double3" 0.96329744057440614 7.1054273576010019e-15 -0.084277605653798604 ;
	setAttr -av ".rx";
	setAttr -av ".ry";
	setAttr -av ".rz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode joint -n "baby_rt_shoulder_def" -p "baby_rt_collar_def";
	...
	setAttr ".t" -type "double3" -2.4758630562090853 3.5527136788005009e-15 -1.1657341758564144e-15 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "baby_rt_ring1_def" -p "baby_rt_cup_def";
	...
	setAttr ".t" -type "double3" -0.83444176813004489 0 -8.8817841970012523e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "baby_lf_ankle_def" -p "baby_lf_knee2_def";
	...
	setAttr ".t" -type "double3" 3.2968550038677402 -0.013009169296339249 0.099725697414580927 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "baby_lf_ball_def" -p "baby_lf_ankle_def";
	...
	setAttr ".t" -type "double3" 0.88833403997654581 -0.21468767090793486 0.078544500590836758 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "baby_rt_ankle_def" -p "baby_rt_knee2_def";
	...
	setAttr ".t" -type "double3" -3.2968842131102924 0.01300485120875286 -0.099729392303502307 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "baby_rt_ball_def" -p "baby_rt_ankle_def";
	...
	setAttr ".t" -type "double3" -0.88833449061022574 0.21469215902985539 -0.078545916968136398 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
