...
//Name: shotglass_var2.ma
//Last modified: Tue, Sep 27, 2016 06:05:49 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	rename -uid "87DB5CF4-0A4A-ECA5-8AB3-308F304D4458";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 50.85098130911971 8.6256774177898858 12.867276423231964 ;
	setAttr ".r" -type "double3" -9.338352729679853 75.799999999996487 -3.2413971862980745e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FFF06640-DB41-47C8-0AC4-E3ADC780B925";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 53.158173534913196;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "289F43F6-284B-C42C-E609-EFB35EEA3782";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 100.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "D4A7F742-A340-8EA8-881B-F79ECD8841AF";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "C2312BF6-A34C-03B5-2255-D39DF54B012E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "0BBDFA2D-A643-932C-BB2E-8296B966EB99";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "AACEA12A-A846-35F4-59D5-709B39694CC8";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "3BC3BB28-7E48-81C0-56A4-3A8913775505";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 30;
...
createNode transform -n "pCylinder1";
	rename -uid "40028C68-4041-A3C6-4DB8-BFB723B65A24";
	setAttr ".t" -type "double3" 0 0.62271638812200436 0 ;
	setAttr ".s" -type "double3" 1 0.11931003094951607 1 ;
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	rename -uid "FC0D3A0E-3143-A9C1-C005-638D4D63D318";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr -s 18 ".pt";
	setAttr ".pt[130]" -type "float3" 2.1561687 31.619911 -2.1561687 ;
	setAttr ".pt[131]" -type "float3" -1.2488034e-07 31.619911 -3.049284 ;
	setAttr ".pt[132]" -type "float3" -1.2488034e-07 31.619911 -2.668124 ;
	setAttr ".pt[133]" -type "float3" 1.8866484 31.619911 -1.8866482 ;
	setAttr ".pt[134]" -type "float3" -2.1561689 31.619911 -2.1561687 ;
	setAttr ".pt[135]" -type "float3" -1.8866484 31.619911 -1.8866484 ;
	setAttr ".pt[136]" -type "float3" -3.0492847 31.619911 -4.7532442e-08 ;
	setAttr ".pt[137]" -type "float3" -2.668124 31.619911 -4.7532442e-08 ;
	setAttr ".pt[138]" -type "float3" -2.1561689 31.619911 2.1561687 ;
	setAttr ".pt[139]" -type "float3" -1.8866484 31.619911 1.8866482 ;
	setAttr ".pt[140]" -type "float3" -1.2488034e-07 31.619911 3.049284 ;
	setAttr ".pt[141]" -type "float3" -1.2488034e-07 31.619911 2.6681242 ;
	setAttr ".pt[142]" -type "float3" 2.1561689 31.619911 2.1561689 ;
	setAttr ".pt[143]" -type "float3" 1.8866484 31.619911 1.8866484 ;
	setAttr ".pt[144]" -type "float3" 3.0492847 31.619911 -1.0252917e-14 ;
	setAttr ".pt[145]" -type "float3" 2.6681242 31.619911 -1.0252917e-14 ;
	setAttr ".dr" 3;
	setAttr ".dsm" 2;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "147B511F-6B4A-3BF9-0BE1-4FB224D0328E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "0FD78652-EB45-94CF-564D-FAB738323D79";
createNode displayLayer -n "defaultLayer";
	rename -uid "A7557DAA-184E-BCA8-CC25-8AA7320B772A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E1F8B081-E743-0C79-F970-669D4F85E4CE";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "B40E54F2-7A4E-18A4-4AB6-D4BEA8D08087";
	setAttr ".g" yes;
createNode RenderMan -s -n "renderManRISGlobals";
	rename -uid "43CFB7CF-2646-5C48-0181-A68432B29477";
...
createNode RenderMan -s -n "rmanFinalGlobals";
	rename -uid "153B2D2B-A24A-B657-75F4-1DA053BDA4D6";
...
createNode RenderMan -s -n "rmanFinalOutputGlobals0";
	rename -uid "774A1B2B-1242-6C72-104E-F2BAC4CC64CF";
	addAttr -ci true -h true -sn "t" -ln "isTemplate" -at "long";
	addAttr -ci true -h true -sn "rman__torattr___class" -ln "rman__torattr___class" 
		-dt "string";
	addAttr -ci true -h true -sn "rman__torattr___task" -ln "rman__torattr___task" -dt "string";
...
createNode RenderMan -s -n "rmanRerenderRISGlobals";
	rename -uid "321328D2-3F47-6907-2417-F1AF0FE6DF71";
	addAttr -ci true -h true -sn "t" -ln "isTemplate" -at "long";
	addAttr -ci true -h true -sn "rman__torattr___class" -ln "rman__torattr___class" 
		-dt "string";
	addAttr -ci true -h true -sn "rman__torattr___task" -ln "rman__torattr___task" -dt "string";
...
createNode RenderMan -s -n "rmanRerenderRISOutputGlobals0";
	rename -uid "BE21EC2F-E24D-EFA0-3A8F-BE8C6FFCEBF4";
	addAttr -ci true -h true -sn "t" -ln "isTemplate" -at "long";
	addAttr -ci true -h true -sn "rman__torattr___class" -ln "rman__torattr___class" 
		-dt "string";
	addAttr -ci true -h true -sn "rman__torattr___task" -ln "rman__torattr___task" -dt "string";
...
createNode polyCylinder -n "polyCylinder1";
	rename -uid "03663F44-9E44-9DEE-5CE8-9D9C556AF4A3";
	setAttr ".r" 4.2264;
	setAttr ".h" 8.7925;
	setAttr ".sa" 8;
	setAttr ".sc" 8;
...
createNode polyExtrudeFace -n "polyExtrudeFace1";
	rename -uid "6443C34A-354B-A5DB-7FCA-9587EC593809";
	setAttr ".ics" -type "componentList" 1 "f[64:71]";
	setAttr ".ix" -type "matrix" 1 0 0 0 0 0.11931003094951607 0 0 0 0 1 0 0 0.62271638812200436 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 2.3841858e-07 1.1472331 0 ;
	setAttr ".rs" 187163889;
	setAttr ".lt" -type "double3" -3.1086244689504383e-15 -6.7043848915259948e-17 6.5441015293950713 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -4.2263994216918945 1.1472330843759155 -4.2263994216918945 ;
	setAttr ".cbx" -type "double3" 4.2263998985290527 1.1472330843759155 4.2263994216918945 ;
createNode partition -n "mtorPartition";
	rename -uid "4D92CB1E-8546-B0E8-0299-B8888FBA2D17";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "AB68C398-524B-8EFA-3060-A1A9EB7A8CAA";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "22A33762-A04D-688B-C911-C5BE9FF76FD6";
