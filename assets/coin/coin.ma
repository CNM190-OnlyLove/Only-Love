...
//Name: coin.ma
//Last modified: Tue, Oct 04, 2016 05:35:52 PM
//Codeset: 1252
requires maya "2016";
requires -nodeType "RenderMan" -nodeType "PxrLMMetal" "RenderMan_for_Maya" "20.7";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.689680440905124 1.3924518467568858 5.6044207809717417 ;
	setAttr ".r" -type "double3" 165.72927896981204 -1235.9261902689213 180.00000000008734 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 6.6102481712207721;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.54374983906745911 0.45694708824157715 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2452D3EF-4368-9C31-3CDA-4DBE9B637387";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "9871ABE0-4D73-FD7D-9C99-38B35FF18A2C";
createNode displayLayer -n "defaultLayer";
	rename -uid "4F108B99-464E-495A-8E92-51A1646A7E40";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "757E5440-45A2-6C7D-29E3-A187D6F84DFD";
